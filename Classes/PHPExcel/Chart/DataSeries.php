...
class PHPExcel_Chart_DataSeries
{
	 ...
	 * Plot Options
	 *
	 * @var array of options for renderer
	 */
	 ...
	 */
	public function __construct($plotType = null, $plotGrouping = null, $plotOrder = array(), $plotLabel = array(), $plotCategory = array(), $plotValues = array(), $smoothLine = null, $plotStyle = null, $plotOptions = array())
	{
		...
		if ((count($plotLabel) == 0) || (is_null($plotLabel[$keys[0]]))) {
			if (!isset($keys[0])) {
				echo('<pre>PHPExcel/Chart/DataSeries.php' . "\n\n");
	...
	public function setPlotGrouping($groupingType = null) {
		$this->_plotGrouping = $groupingOptions;
        return $this;
	}
	 ...
	 * Set Plot Options
	 *
	 * @param string $plotOptions
     * @return PHPExcel_Chart_DataSeries
	 */
	public function setPlotOptions($plotOptions = array()) {
		$this->_plotOptions = $plotOptions;
        return $this;
	}
