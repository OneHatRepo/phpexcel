...
class PHPExcel_Chart
{
	 ...
	 */
	public function __construct($name, PHPExcel_Chart_Title $title = null, PHPExcel_Chart_Legend $legend = null, PHPExcel_Chart_PlotArea $plotArea = null, $plotVisibleOnly = true, $displayBlanksAs = '0', PHPExcel_Chart_Title $xAxisLabel = null, PHPExcel_Chart_Title $yAxisLabel = null, $xAxisOptions = array(), $yAxisOptions= array())
	{
		$this->_name = $name;
		$this->_title = $title;
		$this->_legend = $legend;
		...
		$this->_yAxisOptions = $yAxisOptions;
	}
	 ...
	 * @return	array
	 */
	public function setXAxisOptions($options) {
		$this->_xAxisOptions = $options;
	 ...
	 * @return	array
	 */
	public function setYAxisOptions($options) {
		$this->_yAxisOptions = $options;
