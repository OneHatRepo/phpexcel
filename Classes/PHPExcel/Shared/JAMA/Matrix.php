...
require_once PHPEXCEL_ROOT . 'PHPExcel/Shared/JAMA/QRDecomposition.php'; // SKOTE MOD
require_once PHPEXCEL_ROOT . 'PHPExcel/Shared/JAMA/utils/Maths.php'; // SKOTE MOD
...
class PHPExcel_Shared_JAMA_Matrix {
	...
	public function solve($B) {
		if ($this->m == $this->n) {
			...
			$QR = new PHPExcel_Shared_JAMA_QRDecomposition($this); // SKOTE MOD
			return $QR->solve($B);
		}
	}	//	function solve()
